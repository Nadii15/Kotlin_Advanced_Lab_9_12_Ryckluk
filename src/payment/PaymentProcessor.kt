class PaymentProcessor {
    ...
    fun pay(payment: Payment): PaymentResult{
        ...
        return when (payment.type){
            CarType.VISA -> PaymentResult.Success("VISA - ${System.currentTimeMillis()}")
            CarType.MASTERCARD -> PaymentResult.Processing
            CarType.MIR -> PaymentResult.Success("MIR - ${System.currentTimeMillis()}")
            CarType.UNKNOWN -> PaymentResult.Error("Неизвестный тип карты")
        }
